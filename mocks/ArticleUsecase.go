...
func (_m *ArticleUsecase) Store(_a0 context.Context, _a1 *menekel.Article) (*menekel.Article, error) {
...
func (_m *ArticleUsecase) Update(ctx context.Context, ar *menekel.Article) (*menekel.Article, error) {
